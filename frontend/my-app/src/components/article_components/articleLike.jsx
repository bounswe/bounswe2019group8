...
class ArticleLike extends Component {
  ...
  render() {
    ...
    if (this.props.likeState === 1) {
      return (
        <React.Fragment>
          <FaThumbsUp className='LikeDislikeButton' style={{ marginRight: 10, color: "#3C3C3C" }} onClick={() => this.unlike()} />
        </React.Fragment>
      )
    }
      ...
      return (
        <React.Fragment>
          <FaThumbsUp className='LikeDislikeButton' style={{ marginRight: 10, color: "#A4A4A4" }} onClick={() => this.like()} />
        </React.Fragment>)
