    ...
    if (this.props.likeState === 2) {
      return (
        <React.Fragment>
          ...
          <FaThumbsDown style={{ marginRight: 10, marginTop:10, color: "#3C3C3C", fontSize: "20px" }} onClick={() => this.undislike()} />
        </React.Fragment>
      )
    }
    else {
      return (
        <React.Fragment>
          ...
          <FaThumbsDown style={{ marginRight: 10,  marginTop:10, color: "#A4A4A4", fontSize: "20px" }} onClick={() => this.dislike()} />
        </React.Fragment>)
