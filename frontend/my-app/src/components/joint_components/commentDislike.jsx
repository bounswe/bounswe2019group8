  ...
  render() {
    ...
    if(this.props.likeState===2){
      return(
          ...
          <FaThumbsDown style={{ marginRight: 10, marginTop:20, color: "#3C3C3C" , fontSize: "30px" }} onClick={() => this.undislike()} />
          </React.Fragment>
          )
  }
  else {
    ...
    <FaThumbsDown style={{ marginRight: 10, marginTop:20, color: "#A4A4A4" , fontSize: "30px" }} onClick={() => this.dislike()} />
      </React.Fragment>)
